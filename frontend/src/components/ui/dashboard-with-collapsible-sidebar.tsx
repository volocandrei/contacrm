...
import {
  // lucide-react v1 dropped the legacy aliases:
  // Home -> House, BarChart3 -> ChartColumn, HelpCircle -> CircleQuestionMark.
  House as Home,
  DollarSign,
  Monitor,
  ShoppingCart,
...
// Kept static so values do not change on every re-render (e.g. toggling dark mode).
const TOP_PRODUCTS = [
